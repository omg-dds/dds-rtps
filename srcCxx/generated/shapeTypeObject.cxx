...
const TypeObject* GetMinimalShapeTypeObject()
{
    ...
    mst_color.common().member_type_id(*TypeObjectFactory::get_instance()->get_string_identifier(128, false));
...
const TypeObject* GetCompleteShapeTypeObject()
{
    ...
    cst_color.common().member_type_id(*TypeObjectFactory::get_instance()->get_string_identifier(128, false));
