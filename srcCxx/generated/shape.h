...
public:
     ...
     */
    eProsima_user_DllExport const eprosima::fastrtps::fixed_string<128>& color() const;

    /*!
     * @brief This function returns a reference to member color
     * @return Reference to member color
     */
    eProsima_user_DllExport eprosima::fastrtps::fixed_string<128>& color();
    /*!
...
private:
    ...
    eprosima::fastrtps::fixed_string<128> m_color;
    int32_t m_x;
    int32_t m_y;
    int32_t m_shapesize;
