...
results are organized in the following spreadsheet. The first tab presents a
comprehensive summary of the tests per product. The first table delineates the
number of passed tests versus total tests, offering a quick overview of vendor
compliance. The second table delineates the tests performed between products
acting as **Publishers** and **Subscribers**, providing insights into
